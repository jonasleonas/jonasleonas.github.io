...
const Chart = () => {
  ...
  const [dataIdSun, setDataIdSun] = useState(1)
  const [data, setData] = useState(epi_labels)
  const [dataSun, setDataSun] = useState(sun_data)
  ...
  const changeSun = () => {
    if (sun_state.dataId_sun === 1) {
      setDataIdSun(2)
      setDataSun(maunder_sun)
    } else if (sun_state.dataId_sun === 2) {
      setDataIdSun(3)
      setDataSun(dalton_sun)
    } else if (sun_state.dataId_sun === 3) {
      setDataIdSun(4)
      setDataSun(modern_sun)
    } else if (sun_state.dataId_sun === 4) {
      setDataIdSun(1)
      setDataSun(sun_data)
    }
  }
    ...
    <div>
      ...
      >
        ...
        <VictoryLine
          ...
          width={1200}
          data={this.sun_state.data} x = "x" y = "y"
        />
        <VictoryScatter
      ...
      >
        Cycle between Pandemic and Famine
      </button>
      <VictoryChart
      ...
      >
        ...
        <VictoryScatter
          ...
          labelComponent={
          <VictoryLabel
              backgroundStyle={{  fill: "green", opacity: 0.4}}
              backgroundPadding={8}
